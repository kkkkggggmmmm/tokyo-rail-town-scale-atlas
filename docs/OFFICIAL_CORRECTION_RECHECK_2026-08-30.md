...
| 2020 Census mesh | e-Stat records JGD2011 downloads from 2024-03-14 and 1km/500m/250m prefectural downloads for JGD2000/JGD2011 from 2025-10-09; the newer 125m reference-table addition is separate. | Continue to use only registered 500m tables for Phase 1. Do not let a later distribution event masquerade as the 2020-10-01 census reference date. |
